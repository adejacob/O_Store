		...
		while($row=$get_payment->fetch()):
			...
			echo"<tr>
					...
					if($status == 'Complete'){
						...
						echo"<td><a href='user_pro.php?myorder&cancle=".$row['pay_id']."'></a></td>";
					}
				echo"</tr>";
		endwhile;
	...
	function pro_details(){
		...
		if(isset($_GET['pro_id'])){
			...
			echo"<div id='pro_img'>
				...
				<div id='pro_features'>
					...
					if($row_pro['pro_qty'] > 1){ 
						...
						echo"<h4 style='color:#2e2e2e; text-decoration:none'>Selling Price : ".$row_pro['pro_dis_price']."</h4>
								...
								<p><font color='blue'>Products Delivered In Good Condition Cannot Be Returned</font></p><br />
				...
				echo"<div id='share'>
						<div id='f'>
							<a href='http://www.facebook.com/sharer.php?u=https://outfitsystemstore.net/pro_detail.php?pro_id=$pro_id' title='Facebook Share' target='_blank'>Fb Share</a>
						</div>
						<div id='gp'>
							<a href='http://plus.google.com/share?url=https://outfitsystemstore.net/pro_detail.php?pro_id=$pro_id' target='_blank' title='Google Plus Share'>G+ Share</a>
						</div>
						<div id='t'>
							<a href='https://twitter.com/intent/tweet?text=Check Out This At https://outfitsystemstore.net/pro_detail.php?pro_id=$pro_id' target='_blank' title='Twitter Tweet'>Tweet</a>
						</div>
						<div id='wp'>
							<a href='whatsapp://send?text=".$row_pro['pro_name']." https://outfitsystemstore.net/pro_detail.php?pro_id=$pro_id' target='_blank'>Whatsapp Share</a>
						</div>					
					</div></center>
					<span id='keystrok'></span>
					<span id='keystrok'></span>
